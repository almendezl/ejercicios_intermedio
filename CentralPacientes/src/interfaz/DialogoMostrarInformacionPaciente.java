 ...
 */
public class DialogoMostrarInformacionPaciente extends JDialog 
     ...
     */
    public DialogoMostrarInformacionPaciente(InterfazCentralPacientes ventana, 
            Paciente elPaciente) {
        super( ventana, true );
        principal = ventana;
        paciente = elPaciente;
    ...
    public void actionPerformed( ActionEvent e ) {
        ...
        if( comando.equals( CERRAR ) ) {
            ...
            if( nuevaInformacion != null && !nuevaInformacion.equals( "" ) ) {
                ...
                JOptionPane.showMessageDialog(this, "La información médica del "
                        + "paciente ha sido actualizada", "Búsqueda de Pacientes", 
                        JOptionPane.INFORMATION_MESSAGE );
            }
            else {
                JOptionPane.showMessageDialog( this, "La información médica del "
                        + "paciente no puede ser vacía", "Búsqueda de Pacientes", 
