...
public class PanelArbol extends JPanel {
    ...
    private void dibujarArbol(Graphics g) {
        ...
        if(imagenArbol.getWidth() > getWidth())
            ...
            g.drawImage(imagenArbol, (getWidth() - imagenArbol.getWidth()) / 2, 
                    0, null);
    }
    ...
    public void actualizarImagen() {
        if(interpol != null) {
            ...
            if(primeraCiudad != null) {
                ...
                setPreferredSize(new Dimension(imagenArbol.getWidth(), 
                        imagenArbol.getHeight()));
                setSize(new Dimension(imagenArbol.getWidth(), 
                        imagenArbol.getHeight()));
            }
            else {
                imagenArbol = new BufferedImage(1, 1, BufferedImage.TYPE_INT_RGB);
    ...
    /**
     * Este método se encarga de dibujar una ciudad y a todas las que están debajo 
     * de ella.
    ...
    /**
     * Este método se encarga de dibujar una ciudad (sin dibujar ciudades hijas 
     * si las tiene)
    ...
    private BufferedImage dibujarCiudad(Ciudad ciudad) {
        ...
        BufferedImage imagen = new BufferedImage(ANCHO + BORDE_X * 2, ALTO + 
                BORDE_Y * 2, BufferedImage.TYPE_INT_RGB);
        ...
        // Dibujar el texto
        String texto = ciudad.darNombreCiudad().substring(0, Math.min(18, 
                ciudad.darNombreCiudad().length()));
