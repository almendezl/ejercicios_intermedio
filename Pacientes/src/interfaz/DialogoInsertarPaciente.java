    ...
    public void actionPerformed( ActionEvent e ) {
        ...
        if( comando.equals( AGREGAR ) ) {
            try {
                ...
                int laPrioridad = 0;
                if( elCodigo < 0 ) {
                    JOptionPane.showMessageDialog( this, "El código debe ser un "
                            + "número positivo", "Adición de Pacientes", 
                            JOptionPane.ERROR_MESSAGE );
                }
                else if( elNombre == null || elNombre.equals( "" ) ) {
                    JOptionPane.showMessageDialog( this, "Debe ingresar el nombre "
                            + "del paciente", "Adición de Pacientes", 
                            JOptionPane.ERROR_MESSAGE );
                }
                else if( laClinica == null || laClinica.equals( "" ) ) {
                    JOptionPane.showMessageDialog( this, "Debe ingresar la clínica "
                            + "del paciente", "Adición de Pacientes", 
                            JOptionPane.ERROR_MESSAGE );
                }
                else if( laHistoria == null || laHistoria.equals( "" ) ) {
                    JOptionPane.showMessageDialog( this, "Debe ingresar la historia "
                            + "clinica del paciente", "Adición de Pacientes", 
                            JOptionPane.ERROR_MESSAGE );
                }
                else {
                    principal.agregarPaciente( formaAdicion, codigo, elCodigo, 
                            elNombre, laClinica, laHistoria, elSexo, laPrioridad );
                    principal.refrescarListaPacientes( );
                    dispose( );
                }
            }
            catch( NumberFormatException ex ) {
                JOptionPane.showMessageDialog( this, "El código debe ser un valor "
                        + "numerico", "Adición de Pacientes", 
                        JOptionPane.ERROR_MESSAGE );
            }
                ...
                JOptionPane.showMessageDialog( this, "El paciente con código " + 
                        codigo + " con relación al cual se va a realizar la "
                                + "adición no se encuentra registrado", 
                        "Adición de Pacientes", JOptionPane.ERROR_MESSAGE );
            }
        }
