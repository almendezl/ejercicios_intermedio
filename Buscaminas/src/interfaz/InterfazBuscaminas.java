...
public class InterfazBuscaminas extends JFrame {
    ...
    // -------------------------------------------------------------------------
    /**
     * Es el modo actual de juego. Según el modo cambia la acción que se realiza 
     * cuando se hace click sobre el campo minado.
     */
    ...
    public InterfazBuscaminas( ) {
        try {
            ...
            JOptionPane.showMessageDialog( this, "Error al cargar el estado inicial " + 
