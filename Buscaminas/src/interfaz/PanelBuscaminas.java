...
public class PanelBuscaminas extends JPanel implements ActionListener {
    ...
    public void actualizar( CampoMinado campoMinado ) {
        ...
        // realiza un ciclo que recorre cada una de las casillas, revisa su estado, 
        //y repinta la casilla dependiendo de su estado
     ...
     * @param estado El estado de la casilla. estado no es BOMBA, BOMBA_ESTALLADA, 
     * MARCADA, MARCADA_EQUIVOCADA o TAPADA
     * @return El número de minas que hay cerca de esta casilla
     */
    private int darMinasSegunEstado( int estado ) {
        int numeroMinas = 0;

        // retorna un número que indica cuantas minas se tienen cerca dependiendo 
