...
public class CampoMinado {
    ...
    // -------------------------------------------------------------------------
    /**
     * Construye un nuevo juego de buscaminas con el tamaño del campo minado y el 
     * número de minas especificados en el archivo de entrada.<br>
     ...
     * De las casillas que están destapadas se muestra el número de minas cercanas. 
     * Si el juego ya terminó se devuelven las casillas con los siguientes estados: <br>
     ...
     * marcar se muestran tapadas a menos que tengan una bomba, en cuyo caso esta 
     * se debe mostrar; las casillas marcadas que tenían una bomba se muestran marcadas, mientras 
     * que las marcadas que no tenían bomba se muestran como marcadas equivocadas; 
     * para las casillasdestapadas se muestra el número de bombas cercanas excepto 
     * para la casilla que contenía la bomba, en la cual se muestra la bomba estallada.
     ...
     * Si el juego terminó y el jugador perdió entonces las casillas tapadas sin 
     * marcar se muestran tapadas a menos que tengan una bomba, en cuyo caso esta se debe mostrar;
     * las casillas marcadas marcadas que tenían una bomba se muestran marcadas, 
     * mientras que las marcadas que no tenían bomba se muestran como marcadas equivocadas; 
     * para las casillas destapadas se muestra el número de bombas cercanas menos 
     * para la casilla que contenía la bomba, en la cual se muestra la bomba estallada.
     * @return Matriz de objetos de tipo Casilla
     */
     ...
     * casilla correspondiente ahora deberá indicar el número de bombas cercanas. <br>
     * <b>post: </b> La casilla está destapada y se actualizó el estado del juego: 
     * número de minas restantes y el tiempo de juego.
    ...
    /**
     * Calcula el tiempo actual cada vez que se hace una jugada. Para ello utiliza 
     ...
     *         Puede ser también JUEGO_GANADO o JUEGO_PERDIDO si el juego ya terminó 
     *         y el jugador ganó o perdió, respectivamente.
     */
     ...
     * <b>pre: </b> La casilla no está marcada ni está destapada y el juego no ha 
     * terminado <br>
    ...
    /**
     * Crea un nuevo campo minado de juego, tapando todas las casillas y redistribuyendo 
     * las minas. El tiempo de inicio del juego se inicializa en 0 <br>
     * <b>post: </b>El campo minado quedó inicializado, sin marcas, con todas las 
     * casillas tapadas, con las minas distribuidas de forma aleatoria y con el tiempo 
     * de inicio en 0. El número de minas destapadas también se actualizó en cero.
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
