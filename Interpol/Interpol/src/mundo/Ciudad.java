...
public class Ciudad {
     ...
     * parámetros. El arreglo de lugares es inicializado con 3 posiciones vacías.
     ...
     * @param nEstaSospechoso True en caso que se encuentre el sospechoso en esta 
     *        ciudad. False de lo contrario.
     */
    @SuppressWarnings("rawtypes")
    ...
    /**
     * Agrega los elementos al iterador que llega como parámetro, utilizando para 
     * esto un recorrido en postorden. <br>
    ...
    /**
     * Agrega los elementos al iterador que llega como parámetro, utilizando para 
     * esto un recorrido en preorden.<br>
     * <b>post: </b> Se retorno el vector para recorrer los elementos del árbol 
     * en preorden.<br>
    ...
    /**
     * Agrega una nueva ciudad como hija de la ciudad identificada con el nombre. <br>
     * Si la ciudad que representa este objeto tiene como nombre: el nombre que 
     * entra como parámetro, se debe agregar la ciudad que entra como parámetro <br>
     ...
     * y ciudadCentral lo es, la ciudad se debe agregar como ciudad central. 
     * Si de lo contrario, ciudadDerecha y ciudadCentral son null, y ciudadIzquierda <br>
     ...
     *         se quiere agregar la nueva ciudad no existe
     * @throws CiudadNoAgregadaException Excepción lanzada cuando la ciudad donde 
     ...
     * @param nombrePadre Nombre de la ciudad que se quiere buscar. Diferente 
     *        de null.
    ...
    /**
     * Retorna una lista de Strings con los nombres de las ciudades que forman el 
     * camino del nodo actual a la hoja con el sospechoso.<br>
     ...
     * <b>inv: </b> <br>
     * El nombre de la ciudad debe ser diferente de null y diferente de vacío<br>
