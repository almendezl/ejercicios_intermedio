...
public class PanelSospechosos extends JPanel implements ActionListener {
     ...
     * @param nSospechosos Lista que contiene las ciudades a ser eliminadas. 
     * Diferente de null pero puede ser vacía.
     */
    @SuppressWarnings("rawtypes")
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if( comando.equals(ACEPTAR)) {
            ...
            int pos = Integer.parseInt(comando.substring(comando.length() - 1, 
                    comando.length()));
     ...
     * @return Posición en el arreglo de sospechosos. Entero mayor o igual a cero.
     */
    public int obtenerSospechosoSeleccionado() {
        ...
        return Integer.parseInt(sospechoso.substring(sospechoso.length() - 1, 
                sospechoso.length())) - 1;
    }
